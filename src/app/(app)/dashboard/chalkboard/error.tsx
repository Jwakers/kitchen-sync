...
export default function ChalkboardError({ error, reset }: ErrorProps) {
  useEffect(() => {
    // Log the error to an error reporting service
    console.error("Chalkboard error:", error);
  }, [error]);
    ...
    <div className="h-full py-10 bg-background flex items-center justify-center">
      <div className="text-center max-w-md px-4">
        ...
        <p className="text-muted-foreground mb-2">
          We encountered an error while loading your chalkboard.
        </p>
